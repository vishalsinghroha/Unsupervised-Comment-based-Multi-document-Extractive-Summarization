...
def run_comment_based_summarization(dataset):
    ...
    my_wmd = pd.read_csv(
        'C:/Users/VISHAL/Documents/final_moo_outputs/important_results/' + str(dataset) + '/' + str(
    ...
    objective5_score = pd.read_csv(
       'C:/Users/VISHAL/Documents/final_moo_outputs/objective_5_version_1/' + str(
    ...
    #    'C:/Users/VISHAL/Documents/final_moo_outputs/processed_documents/' + str(dataset) + '/' + str(dataset) + '.csv')

    my_document_sentences = pd.read_csv(
        'C:/Users/VISHAL/Documents/final_moo_outputs/compressive/compressed_sentences/' + str(dataset) + '_compressed_sentences.csv')
    ...
    filepath2 = 'C:/Users/VISHAL/Documents/final_moo_outputs/actual_summary/' + str(dataset) + '/' + str(
        dataset) + '_1.csv'
    ...
    actual_summary1 = lower_actual_summary1[0]
    for i in range(len(lower_actual_summary1) - 1):
        actual_summary1 = " \n".join([actual_summary1, lower_actual_summary1[i + 1]])
    ...
    filepath3 = 'C:/Users/VISHAL/Documents/final_moo_outputs/actual_summary/' + str(dataset) + '/' + str(
        dataset) + '_2.csv'
    actual_summary2_df = pd.read_csv(filepath3)
    temp_actual_summary2 = actual_summary2_df['sentence']
    lower_actual_summary2 = []

    for sent in temp_actual_summary2:
        lower_actual_summary2.append(str(sent))
        count_summary_line1 += 1

    print('Number of sentences in summary: ' + str(count_summary_line1))
    # print(lower_actual_summary1)

    actual_summary2 = lower_actual_summary2[0]
    for i in range(len(lower_actual_summary2) - 1):
        actual_summary2 = " \n".join([actual_summary2, lower_actual_summary2[i + 1]])

    # actual_summary2 = actual_summary2.replace('.','\n ')
    ...
    lower_actual_summary3 = []

    for sent in temp_actual_summary3:
        lower_actual_summary3.append(str(sent))
        count_summary_line2 += 1

    print('Number of sentences in summary: ' + str(count_summary_line2))
    # print(lower_actual_summary1)

    actual_summary3 = lower_actual_summary3[0]
    for i in range(len(lower_actual_summary3) - 1):
        actual_summary3 = " \n".join([actual_summary3, lower_actual_summary3[i + 1]])

    # actual_summary3 = actual_summary3.replace('.','\n ')
    ...
    filepath5 = 'C:/Users/VISHAL/Documents/final_moo_outputs/actual_summary/' + str(dataset) + '/' + str(
        dataset) + '_4.csv'
    actual_summary4_df = pd.read_csv(filepath5)
    temp_actual_summary4 = actual_summary4_df['sentence']
    lower_actual_summary4 = []

    for sent in temp_actual_summary4:
        lower_actual_summary4.append(str(sent))
        count_summary_line3 += 1

    print('Number of sentences in summary: ' + str(count_summary_line3))
    # print(lower_actual_summary1)

    actual_summary4 = lower_actual_summary4[0]
    for i in range(len(lower_actual_summary4) - 1):
        actual_summary4 = " \n".join([actual_summary4, lower_actual_summary4[i + 1]])

    # actual_summary4 = actual_summary4.replace('.','\n ')

    print("actual summary4 :", actual_summary4)
    ...
    final_population, K = evolution.evolve(EMD_matrix,
                                           ...
                                           actual_summary2,
                                           actual_summary3, actual_summary4)
    ...
    fname1 = 'C:/Users/VISHAL/Documents/final_moo_outputs/compressive/version_1/final_output12345/' + str(dataset) + '/running_time'
    ...
    fname2 = 'C:/Users/VISHAL/Documents/final_moo_outputs/compressive/version_1/final_output12345/' + str(dataset) + '/Min_max_sentence'
    ...
    for individual in final_population:
        ...
        for j in range(len(features)):
            if features[j] == 1:
                if (len(str(Summary).split()) + len(str(actual_text_data[j]).split())) <= 125:
        ...
        if not os.path.isdir(
            ...
            os.makedirs(
                'C:/Users/VISHAL/Documents/final_moo_outputs/compressive/version_1/final_output12345/' + str(dataset) + '/Predicted_summary')
        ...
        f_summary = str(Summary.encode('utf-8'))
        ...
        """Calculate and Record annotator4 score of all solutions to store in .csv"""
        ...
        # actual4_scores = rouge.get_scores(Summary, actual_summary4)
        print("summary4 score :", actual4_scores)
        text_file.write('\n\nRouge score with annotator4 : \n' + str(actual4_scores) + '\n')
        text_file.close()

        annotator4_sol_no.append(solution_no)
        ...
        for k in range(len(actual1_scores.keys())):
            ...
            # score = {
            #    k: (m_key_val.get(k, 0) + n_key_val.get(k, 0) + p_key_val.get(k, 0) + q_key_val.get(k, 0)) / float(4)
            #    for k in
            #    set(m_key_val) & set(n_key_val) & set(p_key_val) & set(q_key_val)}
            score = {
                k: max(m_key_val.get(k, 0), n_key_val.get(k, 0), p_key_val.get(k, 0), q_key_val.get(k, 0))
                for k in
                set(m_key_val) & set(n_key_val) & set(p_key_val) & set(q_key_val)}
    ...
    best_result_df.to_csv(
        'C:/Users/VISHAL/Documents/final_moo_outputs/compressive/version_1/final_output12345/' + str(dataset) + '/Best_resulting_Solutions.csv',
        index=False)
